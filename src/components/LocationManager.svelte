  ...
  {#if expanded}
    <div id="locations-body">
      <p class="hint">
        ...
        letterlijk een kas, buiten of een pot is — sommige taken (zoals opbinden bij tomaat in de
        kas) reageren daarop. Grondsoort is optioneel en geldt voor de hele standplaats.
      </p>
